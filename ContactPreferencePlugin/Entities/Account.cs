...
namespace DataverseModel
{
	...
	[System.Runtime.Serialization.DataContractAttribute()]
	public enum Account_CR950_RiskLevel
	{
	...
	public partial class Account : Microsoft.Xrm.Sdk.Entity
	{
		...
		public partial class Fields
		{
			...
			public const string CR950_RiskLevel = "cr950_risklevel";
			public const string CR950_RiskLevelName = "cr950_risklevelname";
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("cr950_risklevel")]
		public virtual Account_CR950_RiskLevel? CR950_RiskLevel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((Account_CR950_RiskLevel?)(EntityOptionSetEnum.GetEnum(this, "cr950_risklevel")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("cr950_risklevel", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("cr950_risklevelname")]
		public string CR950_RiskLevelName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("cr950_risklevel"))
				{
					return this.FormattedValues["cr950_risklevel"];
				}
				else
				{
					return default(string);
